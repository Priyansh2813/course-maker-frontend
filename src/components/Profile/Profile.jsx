import { Avatar, Button, Container, HStack, Heading, Image, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Stack, Text, VStack } from '@chakra-ui/react';
...
const { isOpen, onClose, onOpen } = useDisclosure();
  return (
        ...
        >
          ...
          <VStack spacing="4" alignItems={["center","flex-start"]}>
            ...
            <HStack>
             ...
             {/** user.Created at is not accesible error at Lecture 43 **/}
    ...
    <Heading children="Playlists" size="md"/>
...
function ChangePhotoBox({
    isOpen,onClose,changeImageSubmitHandler,loading
}){
